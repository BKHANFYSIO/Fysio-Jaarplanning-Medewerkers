...
import { X, Info, Calendar, Filter, FileText, AlertTriangle, Link, Download } from 'lucide-react';
...
export const HelpModal: React.FC<HelpModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] flex flex-col">
        {/* Header - Fixed */}
        ...
        <div className="p-6 space-y-6 overflow-y-auto flex-1">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-blue-900 dark:text-blue-200 mb-1">Eerste bezoek</h4>
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                <h4 className="font-medium text-green-900 dark:text-green-200 mb-2">Huidige Week</h4>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                <h4 className="font-medium text-blue-900 dark:text-blue-200 mb-2">Start- & Eindmomenten Activiteiten</h4>
              ...
              <div className="bg-gray-50 dark:bg-slate-800 p-4 rounded-lg">
                <h4 className="font-medium text-gray-900 dark:text-slate-100 mb-2">Doorlopende Activiteiten</h4>
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
                <h4 className="font-medium text-purple-900 dark:text-purple-200 mb-2">Studiefase Filter</h4>
              ...
              <div className="bg-indigo-50 dark:bg-indigo-900/20 p-4 rounded-lg">
                <h4 className="font-medium text-indigo-900 dark:text-indigo-200 mb-2">Onderwerp Filter</h4>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
                ...
                <div className="text-sm space-y-3">
                  ...
                  <div className="mt-2 rounded border border-red-200 dark:border-red-800 bg-red-100 dark:bg-red-900/20 px-3 py-2 inline-flex items-center gap-3">
                    ...
                    <span className="text-gray-700 dark:text-slate-300">Voorbeeld: einddatum in deze week</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
                ...
                <div className="text-sm space-y-3">
                  ...
                  <ul className="list-disc ml-5 text-gray-800 dark:text-slate-300 space-y-1">
